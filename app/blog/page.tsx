...
export default function BlogIndexPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-24 sm:px-6 lg:px-8">
      ...
      <p className="text-lg text-slate-600 dark:text-[#93adc8] mb-8">
        Conteúdo prático para gestores de restaurantes.
      </p>

      <Link
        href="/execucao-operacional"
        className="mb-12 flex items-center justify-between gap-4 rounded-2xl border border-primary/30 bg-primary/5 p-5 hover:border-primary/60 transition-colors"
      >
        <span className="text-sm sm:text-base text-slate-800 dark:text-[#dce8f3]">
          <strong>Novo por aqui?</strong> Comece pelo guia de Execução
          Operacional para Restaurantes.
        </span>
