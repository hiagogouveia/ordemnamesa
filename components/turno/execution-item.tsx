...
export function ExecutionItem({ task, execution, onToggle }: ExecutionItemProps) {
    ...
    return (
        <button
            ...
            className={`
                ...
                transition-all duration-200 ease-out relative overflow-hidden group active:scale-[0.98]
                ${isDone 
