...
const filled = (size: number, props: SVGProps<SVGSVGElement>) => ({
  width: size,
  height: size,
  viewBox: "0 0 24 24",
  fill: "currentColor",
...
export function Repeat({ size = 24, ...props }: IconProps) {
  return (
    <svg {...stroke(size, props)}>
...
export function CheckSquare({ size = 24, ...props }: IconProps) {
  return (
    <svg {...stroke(size, props)}>
...
export function Camera({ size = 24, ...props }: IconProps) {
  return (
    <svg {...stroke(size, props)}>
...
export function History({ size = 24, ...props }: IconProps) {
  return (
    <svg {...stroke(size, props)}>
...
export function Star({ size = 16, ...props }: IconProps) {
  return (
...
export function Plus({ size = 16, ...props }: IconProps) {
  return (
    <svg {...stroke(size, props)} strokeWidth={2.5}>
