...
export interface KanbanChecklist { id: string; name: string; description?: string; is_required: boolean; recurrence?: string; last_reset_at?: string; assigned_to_user_id?: string; checklist_type?: string; role_id?: string; area_id?: string; area_ids?: string[]; areas_list?: { id: string; name: string; color: string }[]; responsible_user_ids?: string[]; order_index?: number | null; restaurant_id?: string; roles?: { id: string; name: string; color: string }; areas?: { id: string; name: string; color: string }; start_time?: string; end_time?: string; allow_early_start?: boolean; is_one_shot?: boolean | null; source_template_id?: string | null; supplier_id?: string | null; [key: string]: unknown; }
